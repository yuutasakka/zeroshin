        ...
        {step === 'phone-input' && (
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <form onSubmit={handleSendOTP} className="space-y-6">
              ...
              <div className="w-full bg-gray-50 rounded-lg p-4 border-2 border-gray-200 mt-4">
                <div className="flex items-start space-x-3">
                  ...
                  <label 
                    ...
                    onClick={() => setAgreedToTerms(!agreedToTerms)}
                  >
                    <a href="/privacy-policy" target="_blank" className="text-emerald-600 hover:text-emerald-800 underline font-semibold">プライバシーポリシー</a>
                    および
                    <a href="/terms-of-service" target="_blank" className="text-emerald-600 hover:text-emerald-800 underline font-semibold">利用規約</a>
                    に同意します
                  </label>
                </div>
                {!agreedToTerms && (
