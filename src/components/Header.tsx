          ...
          <div className="flex items-center justify-between" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '4rem' }}>
            <a href="#top" onClick={scrollToTop} className="flex items-center space-x-2 md:space-x-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 rounded-lg p-2 hover:bg-gray-50 transition-all duration-200">
              <div className="flex flex-col">
                <h1 className="text-lg sm:text-xl md:text-2xl font-bold" style={{ color: '#1a1a1a' }}>
                  {headerData.title}
                </h1>
                <span className="hidden sm:block text-xs font-medium" style={{ color: '#666666' }}>
                  AI投資診断プラットフォーム
                </span>
              </div>
            </a>
            ...
            <nav className="hidden md:flex items-center space-x-1">
              <a href="#main-visual-section" onClick={(e) => scrollToSection(e, 'main-visual-section')} className="px-4 py-2 text-sm md:text-base transition-all duration-200 font-medium" style={{ color: '#333333' }} 
                onMouseEnter={(e) => e.currentTarget.style.color = '#ff6b35'}
                onMouseLeave={(e) => e.currentTarget.style.color = '#333333'}>
                サービス
              </a>
              <a href="#reliability-section" onClick={(e) => scrollToSection(e, 'reliability-section')} className="px-4 py-2 text-sm md:text-base transition-all duration-200 font-medium" style={{ color: '#333333' }}
                onMouseEnter={(e) => e.currentTarget.style.color = '#ff6b35'}
                onMouseLeave={(e) => e.currentTarget.style.color = '#333333'}>
                選ばれる理由
              </a>
              <a href="#cta-section" onClick={(e) => scrollToSection(e, 'cta-section')} className="px-4 py-2 text-sm md:text-base transition-all duration-200 font-medium" style={{ color: '#333333' }}
                onMouseEnter={(e) => e.currentTarget.style.color = '#ff6b35'}
                onMouseLeave={(e) => e.currentTarget.style.color = '#333333'}>
                お問い合わせ
              </a>
            ...
            <button
              ...
              aria-label="メニューを開く"
            >
              <svg className="w-6 h-6" style={{ color: '#333333' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                {isMobileMenuOpen ? (
