...
interface CombatPowerResultsNewProps {
...
const CombatPowerResultsNew: React.FC<CombatPowerResultsNewProps> = ({ diagnosisAnswers, onDownloadGuide }) => {
...
export default CombatPowerResultsNew;