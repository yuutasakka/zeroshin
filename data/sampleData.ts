...
export const sampleTestimonials: Testimonial[] = [
  {
    ...
    avatarEmoji: "👨",
    ratingStars: 5,
    text: "MoneyTicketを使って初めて資産運用を始めました。診断結果が非常に分かりやすく、自分に最適な投資商品を見つけることができました。特にリスク許容度の診断が的確で、安心して投資を続けています。毎月の積立投資も順調に増えており、将来への不安が大幅に軽減されました。"
  },
  {
    id: 'testimonial_002',
    ...
    avatarEmoji: "👩",
    ratingStars: 5,
    text: "お金の知識がほとんどなかった私でも、MoneyTicketの診断を受けることで将来の資産形成への道筋が見えました。アドバイザーの方も親切で、定期的な相談ができるのが心強いです。特にNISAの活用方法を教えてもらったおかげで、税制優遇を最大限活用できています。"
  },
  {
    id: 'testimonial_003',
    ...
    avatarEmoji: "👨",
    ratingStars: 4,
    text: "複数の金融機関を比較検討するのが大変でしたが、MoneyTicketで一括診断できるのが便利でした。手数料の比較も分かりやすく、コストを抑えて投資を始めることができました。おかげで年間20万円以上の手数料を節約できています。"
  },
  {
    id: 'testimonial_004',
    ...
    avatarEmoji: "👩",
    ratingStars: 5,
    text: "不安定な収入の中でも、MoneyTicketの診断で自分に合った投資方法を見つけられました。少額から始められる商品を紹介してもらい、無理なく資産形成を続けています。収入の変動に合わせて投資額を調整できるのも助かっています。"
  },
  {
    id: 'testimonial_005',
    ...
    avatarEmoji: "👨",
    ratingStars: 4,
    text: "老後の資産形成に不安を感じていましたが、MoneyTicketの診断で具体的な目標設定ができました。iDeCoやNISAの活用方法も詳しく教えてもらい、税制優遇を最大限活用できています。65歳までに3000万円の目標が現実的に見えてきました。"
  },
  {
    id: 'testimonial_006',
...
export const sampleFirstConsultationOffer: FirstConsultationOffer = {
  title: "初回相談無料キャンペーン",
  description: "MoneyTicketの専門アドバイザーが、あなたの診断結果を詳しく解説し、最適な投資戦略をご提案します。詳細な診断結果の解説（30分）、個別投資戦略の提案、リスク管理アドバイス、税制優遇制度の活用方法、継続サポートプランのご案内を無料で行います。",
  icon: "fas fa-gift",
